...
section_keywords = {
    "PROFILE": ["PROFILE", "SUMMARY", "ABOUT ME", "PERSONAL PROFILE", "PERSONAL SUMMARY"],
    "EXPERIENCE": ["EXPERIENCE", "WORK EXPERIENCE", "JOB HISTORY", "EMPLOYMENT HISTORY"],
...
keywords_section = {keyword: section for section, keywords in section_keywords.items() for keyword in keywords}
